...
namespace robowflex
{
    ...
    namespace OMPL
    {
         ...
         */
        bool loadOMPLConfig(IO::Handler &handler, const YAML::Node& node,
        ...
        public:
            ...
            bool initialize(const YAML::Node& node, const Settings &settings = Settings(),
                            const std::string &plugin = DEFAULT_PLUGIN,
                            const std::vector<std::string> &adapters = DEFAULT_ADAPTERS);

            std::map<std::string, ProgressProperty> getProgressProperties(const SceneConstPtr &scene, const planning_interface::MotionPlanRequest &request) const override;
    ...
    namespace opt
    {
        ...
        bool loadConfig(IO::Handler &handler, const YAML::Node &node);
        ...
        public:
            ...
            bool initialize(const YAML::Node &node, const std::string &plugin = DEFAULT_PLUGIN,
                            const std::vector<std::string> &adapters = DEFAULT_ADAPTERS);
